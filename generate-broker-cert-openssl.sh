...
#
# Default CA paths (monorepo layout): ../proofmqtt/data/ca/root-ca.{crt,key}
# Override:
...
CA_CRT="${CA_CRT:-${HERE}/../proofmqtt/data/ca/root-ca.crt}"
CA_KEY="${CA_KEY:-${HERE}/../proofmqtt/data/ca/root-ca.key}"
...
echo "OK: ${OUT_DIR}/broker.{key,crt} (IP SANs from BROKER_SAN_IPS if set)"
